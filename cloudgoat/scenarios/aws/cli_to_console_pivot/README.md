# Scenario: cli_to_console_pivot

**Size:** Medium

**Difficulty:** Moderate

**Command:** `./cloudgoat.py create cli_to_console_pivot`
...
![clis_to_console_pivot](FlowChart.png)
...
## Walkthrough - CLI to Console Pivot
...
##  Mitigations for CLI-to-Console Pivot via IMDSv2
