# IAM Configuration for cli_to_console_pivot scenario
...
# EC2 Admin Role with elevated permissions - the target for exploitation
...
# EC2 Admin Role Policy - intentionally overprivileged
